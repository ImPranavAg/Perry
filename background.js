...
const extensionDescription =
  "Perry is an extension developed to make the web more accessible to people with dyslexia and color blindness. Perry allows you to change colors, add and remove images, read out pages etc.";
...
function savePreference(e) {
  ...
  localStorage.setItem("perryPreferences", JSON.stringify(Preference));
}
...
document
  ...
  .addEventListener("click", (e) => {
    let localPreference = JSON.parse(localStorage.getItem("perryPreferences"));
